...
> [!IMPORTANT]  
> If you're submitting a bunch of files, very large files, or need to transfer from a cloud VM, we recommend you use the Synapse command line or Python/R client library.  See [tutorial-2.md](tutorial-2.md) for much more info on this.
